...
public class VibraWeeModel<T extends Entity> extends EntityModel<T> {
    ...
    public VibraWeeModel() {
        ...
        this.dorsalfin.setPos(0.0F, -1.0F, 0.0F);
        ...
        this.pelvicfinright.setPos(-0.5F, 2.0F, 0.0F);
        ...
        this.pelvicfinleft.setPos(0.5F, 2.0F, 0.0F);
    ...
    public void setupAnim(T entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.pelvicfinleft.zRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 + 0.5f;
        this.pelvicfinright.zRot = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1 - 0.5f;
    }
