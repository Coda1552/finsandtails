...
public class BullCrabModel<T extends Entity> extends EntityModel<T> {
    ...
    public BullCrabModel() {
        ...
        this.right_eye = new ModelRenderer(this, 1, 2);
        this.right_eye.setPos(1.0F, 1.0F, -3.0F);
        this.right_eye.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(right_eye, 0.39269908169872414F, -0.39269908169872414F, 0.0F);
        ...
        this.left_eye = new ModelRenderer(this, 1, 2);
        this.left_eye.setPos(-1.0F, 1.0F, -3.0F);
        this.left_eye.addBox(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(left_eye, 0.39269908169872414F, 0.39269908169872414F, 0.0F);
