...
public class SwampMuckerModel<T extends Entity> extends EntityModel<T> {
    ...
    public SwampMuckerModel() {
        ...
        this.pectoralfinleft.setRotationPoint(1.5F, -1.0F, -1.5F);
        ...
        this.pectoralfinright.setRotationPoint(-1.5F, -1.0F, -1.5F);
    ...
    public void setRotationAngles(T entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.pectoralfinleft.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1;
        this.pectoralfinright.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1;
        this.pelvicfinleft.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 + -0.2f;
        this.pelvicfinright.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1 + 0.2f;
