...
public class FinsEntities {
    ...
    public static final RegistryObject<EntityType<RubberBellyGliderEntity>> RUBBER_BELLY_GLIDER = create("rubber_belly_glider", EntityType.Builder.create(RubberBellyGliderEntity::new, EntityClassification.WATER_CREATURE).size(0.7f, 0.285f));
