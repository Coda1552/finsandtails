...
public class FinsItems {
    ...
    public static final RegistryObject<Item> TEAL_ARROWFISH = REGISTER.register("teal_arrowfish", () -> new TealArrowfishItem(new Item.Properties().group(FinsAndTails.GROUP).food(new Food.Builder().hunger(2).saturation(0.1F).build())));
    ...
    public static final RegistryObject<Item> EMERALD_SPINDLY_GEM_CRAB = REGISTER.register("emerald_spindly_gem_crab", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> AMBER_SPINDLY_GEM_CRAB = REGISTER.register("amber_spindly_gem_crab", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> RUBY_SPINDLY_GEM_CRAB = REGISTER.register("ruby_spindly_gem_crab", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> SAPPHIRE_SPINDLY_GEM_CRAB = REGISTER.register("sapphire_spindly_gem_crab", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> PEARL_SPINDLY_GEM_CRAB = REGISTER.register("pearl_spindly_gem_crab", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    ...
    public static final RegistryObject<Item> SPINDLY_RUBY = REGISTER.register("spindly_ruby", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> SPINDLY_PEARL = REGISTER.register("spindly_pearl", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> SPINDLY_EMERALD = REGISTER.register("spindly_emerald", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> SPINDLY_AMBER = REGISTER.register("spindly_amber", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<Item> SPINDLY_SAPPHIRE = REGISTER.register("spindly_sapphire", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    ...
    public static final RegistryObject<Item> SEAFOOD_SOUP = REGISTER.register("seafood_soup", () -> new SoupItem(new Item.Properties().group(FinsAndTails.GROUP).food(new Food.Builder().hunger(18).saturation(0.8f).build()).maxStackSize(1)));
    public static final RegistryObject<Item> CRAB_SANDWICH = REGISTER.register("crab_sandwich", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP).food(new Food.Builder().hunger(17).saturation(0.55f).effect(() -> new EffectInstance(Effects.STRENGTH, 160), 1.0F).build())));
    ...
    public static final RegistryObject<Item> REEF_COCKTAIL = REGISTER.register("reef_cocktail", () -> new SoupItem(new Item.Properties().group(FinsAndTails.GROUP).food(new Food.Builder().hunger(6).saturation(0.5f).effect(() -> new EffectInstance(Effects.RESISTANCE, 100), 1.0F).effect(() -> new EffectInstance(Effects.WATER_BREATHING, 200), 0.75F).build()).maxStackSize(1)));
    public static final RegistryObject<Item> WEE_DELIGHT = REGISTER.register("wee_delight", () -> new SoupItem(new Item.Properties().group(FinsAndTails.GROUP).food(new Food.Builder().hunger(8).saturation(0.4f).fastToEat().build()).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> EMPTY_CHARM = REGISTER.register("empty_charm", () -> new Item(new Item.Properties().group(FinsAndTails.GROUP)));
    ...
    public static final RegistryObject<Item> MUSIC_DISC_CRASHING_TIDES = REGISTER.register("music_disc_crashing_tides", () -> new MusicDiscItem(1, FinsSounds.CRASHING_TIDES::get, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1).rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<Item> RED_BULL_CRAB_BUCKET = REGISTER.register("red_bull_crab_bucket", () -> new FinsBucketItem(FinsEntities.RED_BULL_CRAB, () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> WHITE_BULL_CRAB_BUCKET = REGISTER.register("white_bull_crab_bucket", () -> new FinsBucketItem(FinsEntities.WHITE_BULL_CRAB, () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> FLATBACK_LEAF_SNAIL_POT = REGISTER.register("flatback_leaf_snail_pot", () -> new FinsBucketItem(FinsEntities.FLATBACK_LEAF_SNAIL, () -> Fluids.EMPTY, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> SIDEROL_WHISKERED_SNAIL_POT = REGISTER.register("siderol_whiskered_snail_pot", () -> new FinsBucketItem(FinsEntities.SIDEROL_WHISKERED_SNAIL, () -> Fluids.EMPTY, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> GOPJET_BUCKET = REGISTER.register("gopjet_bucket", () -> new FinsBucketItem(FinsEntities.GOPJET, () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> GOPJET_SPAWN_EGG = REGISTER.register("gopjet_spawn_egg", () -> new FinsSpawnEggItem(FinsEntities.GOPJET, 0xcfe0ff, 0x403c70, new Item.Properties().group(FinsAndTails.GROUP)));
    ...
    public static final RegistryObject<Item> BANNER_PATTERN_SHELL = REGISTER.register("banner_pattern_shell", () -> new BannerPatternItem(registerPattern("shell"), new Item.Properties().maxStackSize(1).group(FinsAndTails.GROUP)));
    ...
    public static final RegistryObject<BlockItem> SPINDLY_RUBY_BLOCK = REGISTER.register("spindly_ruby_block", () -> new BlockItem(FinsBlocks.SPINDLY_RUBY_BLOCK.get(), new Item.Properties().group(FinsAndTails.GROUP)));
    public static final RegistryObject<BlockItem> SPINDLY_AMBER_BLOCK = REGISTER.register("spindly_amber_block", () -> new BlockItem(FinsBlocks.SPINDLY_AMBER_BLOCK.get(), new Item.Properties().group(FinsAndTails.GROUP)));
