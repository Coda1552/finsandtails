...
public class FTItems {
    ...
    public static final RegistryObject<Item> LUMINOUS_CALAMARI = ITEMS.register("luminous_calamari", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.3f).effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 100), 0.5f).build())));
    public static final RegistryObject<Item> COOKED_LUMINOUS_CALAMARI = ITEMS.register("cooked_luminous_calamari", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(0.5f).effect(() -> new MobEffectInstance(MobEffects.NIGHT_VISION, 200), 1.0f).build())));
