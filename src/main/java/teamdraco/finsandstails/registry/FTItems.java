...
public class FTItems {
    ...
    //Fish
    public static final RegistryObject<Item> BLU_WEE = ITEMS.register("blu_wee", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.1F).fast().build())));
    public static final RegistryObject<Item> PEA_WEE = ITEMS.register("pea_wee", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.1F).fast().build())));
    ...
    public static final RegistryObject<Item> HIGH_FINNED_BLUE = ITEMS.register("high_finned_blue", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.1F).build())) {
        @Override
    ...
    public static final RegistryObject<Item> VIBRA_WEE = ITEMS.register("vibra_wee", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(0.2F).fast().build())));
    public static final RegistryObject<Item> NIGHT_LIGHT_SQUID = ITEMS.register("night_light_squid", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationMod(0.1F).build())));
    ...
    //Drops
    public static final RegistryObject<Item> MUDHORSE_LEATHER = ITEMS.register("mudhorse_leather", () -> new Item(new Item.Properties()));
    ...
    //Buckets
    public static final RegistryObject<Item> BLU_WEE_BUCKET = ITEMS.register("blu_wee_bucket", () -> new MobBucketItem(FTEntities.BLU_WEE, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> PEA_WEE_BUCKET = ITEMS.register("pea_wee_bucket", () -> new MobBucketItem(FTEntities.PEA_WEE, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> PENGLIL_BUCKET = ITEMS.register("penglil_bucket", () -> new FinsBucketItem(FTEntities.PENGLIL, () -> Fluids.EMPTY, new Item.Properties().stacksTo(1), true));
    public static final RegistryObject<Item> SPINDLY_GEM_CRAB_BUCKET = ITEMS.register("spindly_gem_crab_bucket", () -> new FinsBucketItem(FTEntities.SPINDLY_GEM_CRAB, () -> Fluids.WATER, new Item.Properties().stacksTo(1), true));
    ...
    public static final RegistryObject<Item> VIBRA_WEE_BUCKET = ITEMS.register("vibra_wee_bucket", () -> new FinsBucketItem(FTEntities.VIBRA_WEE, () -> Fluids.WATER, new Item.Properties().stacksTo(1), true));
    public static final RegistryObject<Item> GOLDEN_RIVER_RAY_BUCKET = ITEMS.register("golden_river_ray_bucket", () -> new FinsBucketItem(FTEntities.GOLDEN_RIVER_RAY, () -> Fluids.WATER, new Item.Properties().stacksTo(1), true));
    ...
    public static final RegistryObject<Item> NIGHT_LIGHT_SQUID_BUCKET = ITEMS.register("night_light_squid_bucket", () -> new FinsBucketItem(FTEntities.NIGHT_LIGHT_SQUID, () -> Fluids.WATER, new Item.Properties().stacksTo(1), true));
    ...
    public static final RegistryObject<Item> BABY_HORATEE_BUCKET = ITEMS.register("baby_horatee_bucket", () -> new MobBucketItem(FTEntities.CROWNED_HORATTE, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> CROWNED_HORATEE_SPAWN_EGG = ITEMS.register("crowned_horatee_spawn_egg", () -> new ForgeSpawnEggItem(FTEntities.CROWNED_HORATTE, 0xF7A53D, 0xB34B1B, new Item.Properties()));
