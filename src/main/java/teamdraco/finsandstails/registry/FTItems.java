...
public class FTItems {
    ...
    public static final RegistryObject<Item> FLATBACK_LEAF_SNAIL_POT = ITEMS.register("flatback_leaf_snail_pot", () -> new FinsPotItem(FTEntities.FLATBACK_LEAF_SNAIL, () -> Fluids.EMPTY, new Item.Properties().tab(FinsAndTails.GROUP).stacksTo(1)));
    public static final RegistryObject<Item> RIVER_PEBBLE_SNAIL_POT = ITEMS.register("river_pebble_snail_pot", () -> new FinsPotItem(FTEntities.RIVER_PEBBLE_SNAIL, () -> Fluids.EMPTY, new Item.Properties().tab(FinsAndTails.GROUP).stacksTo(1)));
    public static final RegistryObject<Item> SIDEROL_WHISKERED_SNAIL_POT = ITEMS.register("siderol_whiskered_snail_pot", () -> new FinsPotItem(FTEntities.SIDEROL_WHISKERED_SNAIL, () -> Fluids.EMPTY, new Item.Properties().tab(FinsAndTails.GROUP).stacksTo(1)));
