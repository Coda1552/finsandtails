...
public class FTConfiguredStructures {
    public static StructureFeature<?, ?> CONFIGURED_SAILORS_SHIP = FTStructures.SAILORS_SHIP.get().configured(IFeatureConfig.NONE);
