...
import teamdraco.finsandstails.client.model.armor.SpindlySapphireModel;
import teamdraco.finsandstails.common.items.charms.SpindlySapphireCharm;

public class SpindlySapphireRenderer extends GeoArmorRenderer<SpindlySapphireCharm> {

    public SpindlySapphireRenderer() {
        super(new SpindlySapphireModel());
