...
import teamdraco.finsandstails.client.model.armor.SpindlyEmeraldModel;
import teamdraco.finsandstails.common.items.charms.SpindlyEmeraldCharm;

public class SpindlyEmeraldRenderer extends GeoArmorRenderer<SpindlyEmeraldCharm> {

    public SpindlyEmeraldRenderer() {
        super(new SpindlyEmeraldModel());
