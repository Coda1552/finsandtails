...
public class OrnateBugfishModel<T extends Entity> extends EntityModel<T> {
    ...
    public OrnateBugfishModel() {
        ...
        this.finRight.setPos(-3.0F, 2.0F, 1.0F);
        ...
        this.finBack.setPos(0.0F, 1.5F, 0.0F);
        ...
        this.finTop.setPos(0.0F, -1.5F, 0.0F);
        ...
        this.beakLeftTop.setPos(0.0F, -0.5F, -4.0F);
        ...
        this.beakRightTop.setPos(0.0F, -0.5F, -4.0F);
    ...
    public void setupAnim(T entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.tailBase.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -0.5F * f1;
        this.beakLeftTop.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.5F * f1 + 0.2f;
        this.beakRightTop.yRot = MathHelper.cos(f * speed * 0.4F) * degree * 1.5F * f1 - 0.2f;
        this.finLeft.zRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 - 0.3f;
        this.finRight.zRot = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1 + 0.3f;
    }
