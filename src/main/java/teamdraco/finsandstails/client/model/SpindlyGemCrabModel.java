...
public class SpindlyGemCrabModel<T extends Entity> extends EntityModel<T> {
    ...
    public SpindlyGemCrabModel() {
        ...
        this.left_leg_mid.setPos(1.5F, 1.0F, 0.0F);
        ...
        this.right_leg_mid.setPos(-1.5F, 1.0F, -1.0F);
        ...
        this.antemnas.setPos(0.0F, 0.5F, -2.5F);
        ...
        this.left_pincher.setPos(-1.5F, 0.5F, -2.5F);
        ...
        this.body.setPos(0.0F, 21.6F, 0.0F);
        ...
        this.right_leg_front.setPos(-1.5F, 1.0F, 0.0F);
        ...
        this.right_leg_back.setPos(-1.5F, 1.0F, 1.0F);
        ...
        this.left_leg_back.setPos(1.5F, 1.0F, 1.0F);
        ...
        this.right_pincher.setPos(1.5F, 0.5F, -2.5F);
        ...
        this.left_leg_front.setPos(1.5F, 1.0F, -1.0F);
    ...
    public void setupAnim(T entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.tail.xRot = MathHelper.cos(f * speed * 0.6F) * degree * 0.5F * f1 - 0.5F;
        this.left_pincher.yRot = MathHelper.cos(f * speed * 0.4F) * degree * 0.4F * f1 + 0.6F;
        this.left_leg_front.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 + 0.6F;
        this.left_leg_mid.yRot = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1;
        this.right_leg_front.yRot = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1;
        this.left_leg_back.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 - 0.5F;
        this.right_leg_back.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 + 0.5F;
        this.right_pincher.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -0.4F * f1 - 0.6F;
        this.right_leg_mid.yRot = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1 - 0.6F;
    }
