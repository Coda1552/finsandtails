...
import teamdraco.finsandstails.client.old.model.NightLightSquidModel;
...
public class NightLightSquidGlowLayer<T extends NightLightSquidEntity, M extends NightLightSquidModel<T>>  extends LayerRenderer<T, M> {
    private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(FinsAndTails.MOD_ID, "textures/entity/night_light_squid/night_light_squid_e.png"));
