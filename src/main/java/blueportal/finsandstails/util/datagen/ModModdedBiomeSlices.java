...
import blueportal.finsandstails.registry.FTBiomes;
...
public class ModModdedBiomeSlices {
  public static final ResourceKey<ModdedBiomeSlice> FINS_AND_TAILS = ResourceKey.create(BlueprintDataPackRegistries.MODDED_BIOME_SLICES, new ResourceLocation(FinsAndTails.MOD_ID, "fins_and_tails"));

  public static final ResourceKey<Biome> PENGLIL_PARADISE_AREA = FTBiomes.createKey("penglil_paradise_area");
  ...
  public static void bootstrap(BootstapContext<ModdedBiomeSlice> context) {
    ...
    ModdedBiomeSlice wwSlice = new ModdedBiomeSlice(
            ...
            BiomeUtil.MultiNoiseModdedBiomeProvider.builder()
                    ...
                    .area(PENGLIL_PARADISE_AREA, FTBiomes.PENGLIL_PARADISE)
                    .build(),
            LevelStem.OVERWORLD);
    context.register(FINS_AND_TAILS, wwSlice);
  }
  ...
  private static class WheeziesWoodsBiomeBuilder {
    ...
    private final ResourceKey<Biome>[][] OCEANS = new ResourceKey[][]{
            ...
            {VANILLA, VANILLA, PENGLIL_PARADISE_AREA, PENGLIL_PARADISE_AREA, PENGLIL_PARADISE_AREA}
    };
