...
public class PhantomNudibranchModel<T extends Entity> extends EntityModel<T> {
    ...
    public PhantomNudibranchModel() {
        ...
        this.leftantenna.setRotationPoint(1.0F, -1.0F, -2.5F);
        ...
        this.rightantenna.setRotationPoint(-1.0F, -1.0F, -2.5F);
    ...
    public void setRotationAngles(T entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        float degree = 1.0f;
        float speed = 3.0f;
        this.leftmantle.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * -1.2F * f1;
        this.rightmantle.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * 1.2F * f1;
    }
