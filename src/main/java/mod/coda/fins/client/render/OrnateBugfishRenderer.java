...
public class OrnateBugfishRenderer extends MobRenderer<OrnateBugfishEntity, OrnateBugfishModel<OrnateBugfishEntity>> {
    ...
    public ResourceLocation getEntityTexture(OrnateBugfishEntity entity) {
        return TEXTURE;
    }

    protected void applyRotations(OrnateBugfishEntity entityLiving, MatrixStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
