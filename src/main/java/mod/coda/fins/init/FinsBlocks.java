...
public class FinsBlocks {
    ...
    public static final RegistryObject<Block> PEBBLE_SHELL_BRICK_STAIRS = REGISTER.register("pebble_shell_brick_stairs", () -> new StairsBlock(() -> FinsBlocks.PEBBLE_SHELL_BRICK_SLAB.get().getDefaultState(), Block.Properties.create(Material.ROCK).hardnessAndResistance(1.5f, 6.0F).sound(SoundType.BONE)));
