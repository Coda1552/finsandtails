...
public class FinsItems {
    ...
    public static final RegistryObject<Item> RUBBER_BELLY_GLIDER_BUCKET = REGISTER.register("rubber_belly_glider_bucket", () -> new FishBucketItem(FinsEntities.RUBBER_BELLY_GLIDER, () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
