...
public class FinsItems {
    ...
    public static final RegistryObject<Item> BLU_WEE_BUCKET = REGISTER.register("blu_wee_bucket", () -> new FishBucketItem(() -> FinsEntities.BLU_WEE.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> PEA_WEE_BUCKET = REGISTER.register("pea_wee_bucket", () -> new FishBucketItem(() -> FinsEntities.PEA_WEE.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> BANDED_REDBACK_SHRIMP_BUCKET = REGISTER.register("banded_redback_shrimp_bucket", () -> new FishBucketItem(() -> FinsEntities.BANDED_REDBACK_SHRIMP.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> TEAL_ARROWFISH_BUCKET = REGISTER.register("teal_arrowfish_bucket", () -> new FishBucketItem(() -> FinsEntities.TEAL_ARROWFISH.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> SWAMP_MUCKER_BUCKET = REGISTER.register("swamp_mucker_bucket", () -> new FishBucketItem(() -> FinsEntities.SWAMP_MUCKER.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> FLATBACK_SUCKER_BUCKET = REGISTER.register("flatback_sucker_bucket", () -> new FishBucketItem(() -> FinsEntities.FLATBACK_SUCKER.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> HIGH_FINNED_BLUE_BUCKET = REGISTER.register("high_finned_blue_bucket", () -> new FishBucketItem(() -> FinsEntities.HIGH_FINNED_BLUE.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> PHANTOM_NUDIBRANCH_BUCKET = REGISTER.register("phantom_nudibranch_bucket", () -> new FishBucketItem(() -> FinsEntities.PHANTOM_NUDIBRANCH.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> ORNATE_BUGFISH_BUCKET = REGISTER.register("ornate_bugfish_bucket", () -> new FishBucketItem(() -> FinsEntities.ORNATE_BUGFISH.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> MUDHORSE_POUCH = REGISTER.register("mudhorse_pouch", () -> new MudhorsePouchItem());
    public static final RegistryObject<Item> FWINGED_BOOTS = REGISTER.register("fwinged_boots", () -> new FwingedBootsItem());
    ...
    public static final RegistryObject<Item> PENGLIL_BUCKET = REGISTER.register("penglil_bucket", () -> new PenglilBucketItem(() -> FinsEntities.PENGLIL.get(), new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> SPINDLY_GEM_CRAB_BUCKET = REGISTER.register("spindly_gem_crab_bucket", () -> new FishBucketItem(() -> FinsEntities.SPINDLY_GEM_CRAB.get(), () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> GEM_CRAB_AMULET = REGISTER.register("gem_crab_amulet", () -> new GemCrabAmuletItem());
//    public static final RegistryObject<Item> BUGFISH_MANDIBLES = REGISTER.register("bugfish_mandibles", () -> new ShearsItem(new Item.Properties().group(FinsAndTails.GROUP).maxDamage(156)));
    ...
    public static final RegistryObject<Item> SPINDLY_GEM_CRAB_SPAWN_EGG = REGISTER.register("spindly_gem_crab_spawn_egg", () -> new FinsSpawnEggItem(FinsEntities.PENGLIL,  0xe4ad4c, 0x6be263, new Item.Properties().group(FinsAndTails.GROUP)));
