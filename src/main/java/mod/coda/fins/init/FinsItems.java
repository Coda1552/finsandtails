...
public class FinsItems {
    ...
    public static final RegistryObject<Item> PENGLIL_BUCKET = REGISTER.register("penglil_bucket", () -> new FishBucketItem(FinsEntities.PENGLIL, () -> Fluids.EMPTY, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> VIBRA_WEE_BUCKET = REGISTER.register("vibra_wee_bucket", () -> new FishBucketItem(FinsEntities.VIBRA_WEE, () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    public static final RegistryObject<Item> GOLDEN_RIVER_RAY_BUCKET = REGISTER.register("golden_river_ray_bucket", () -> new FishBucketItem(FinsEntities.GOLDEN_RIVER_RAY, () -> Fluids.WATER, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> RIVER_PEBBLE_SNAIL_POT = REGISTER.register("river_pebble_snail_pot", () -> new FishBucketItem(FinsEntities.RIVER_PEBBLE_SNAIL, () -> Fluids.EMPTY, new Item.Properties().group(FinsAndTails.GROUP).maxStackSize(1)));
